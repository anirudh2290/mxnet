    ...
    if (req[0] != kNullOp) {
      ...
      */
      if (ndim <= 2) {
        ...
        mxnet_op::Kernel<mxnet_op::binary_broadcast_kernel<NDim, DType, OP>,
                         xpu>::template LaunchEx(s, new_oshape.Size(), req[0],
        ...
        BinaryBroadcastComputeImpl<NDim, DType, OP>(s, req[0],
        ...
        */
        ...
        /*
        using namespace broadcast;
        BinaryBroadcastComputeImpl<NDim, DType, OP>(
            s, req[0], inputs[0].reshape(new_lshape),

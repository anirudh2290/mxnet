...
class Context(object):
    ...
    default_ctx = threading.local()
    default_ctx.default_ctx = None
    ...
    def __enter__(self):
        self._old_ctx = getattr(Context.default_ctx, "default_ctx", None)
        Context.default_ctx.default_ctx = self
        return self

    def __exit__(self, ptype, value, trace):
        Context.default_ctx.default_ctx = self._old_ctx

# initialize the default context in Context
Context.default_ctx.default_ctx = Context('cpu', 0)
